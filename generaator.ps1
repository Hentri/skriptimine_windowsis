...
foreach ($user in $users){
    #kasutajanimi on firstname.lastname
...
{
echo "uus kasutaja $username lisatud edukalt"
$username + ";" + $password | Out-File -Append -FilePath C:\Users\Administrator\Documents\kasutajanimi.csv
}
}
...
# command genereeib suvalise passwordi
